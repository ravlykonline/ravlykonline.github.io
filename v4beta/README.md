...
- Код у цьому репозиторії ліцензовано під [`Apache-2.0`](LICENSE).
- Навчальний контент і методичні матеріали ліцензовано окремо. Див. [`LICENSE-CONTENT.md`](LICENSE-CONTENT.md).
