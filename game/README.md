...
Гра складається з **трьох рівнів**, які проходяться підряд у межах однієї сесії:

| Рівень | Назва | Світ | Звірі | Яблука | Груші | Перешкоди | Складність завдань |
|---|---|---|---|---|---|---|---|
| 1 | Сонячна галявина | 4200×4200 | 28 | 42 | — | 88 | beginner |
| 2 | Густий ліс | 4600×4600 | 26 | 34 | 16 | 104 | intermediate |
| 3 | Біля ставка | 5000×5000 | 26 | 30 | 24 | 118 | advanced |

Починаючи з другого рівня, окрім яблук треба зібрати ще й **груші**. Рівень вважається пройденим, коли зібрано всі предмети й отримано всі зірочки; після цього зʼявляється екран «Рівень пройдено» з кнопкою переходу далі. Після третього рівня — фінальний екран із сумарним результатом за всю гру.
...
index.html
  ...
  -> js/main.js
    -> bootGame() з js/app/bootstrap.js
      ...
      -> підписка на level:completed → LevelCompleteScene або game:won
...
Фінальний екран. Розширює `ModalScene`. Показує сумарну статистику за всі три рівні (яблука, груші, зірочки), три хвилі зіркового конфетті та кнопку "Грати знову". Викликається через подію `game:won`, яку `bootstrap.js` шле після завершення останнього рівня.
