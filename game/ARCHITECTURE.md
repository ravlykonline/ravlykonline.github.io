...
5. Винести apple logic.
6. Винести NPC interaction logic.
7. Винести camera logic.
8. Додати `spawn-rules` і тести на валідність світу.
9. Додати `task-contracts` і `task-validator`.
10. Додати `task-evaluators`.
11. Перенести нові математичні задачі в нову task-модель.
12. Додати фінальний екран сесії.
