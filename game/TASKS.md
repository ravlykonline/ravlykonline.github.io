...
### 14.6 `visual-magic-square`

Дитина заповнює маленьку сітку фігурами за простим правилом повторення, без складної арифметики.
...
Для поточної концепції це не пріоритетний тип, якщо він числовий. Краще почати з `visual-magic-square`.
...
7. Додати `visual-magic-square` як задачу з фігурами, якщо UX лишається простим.
