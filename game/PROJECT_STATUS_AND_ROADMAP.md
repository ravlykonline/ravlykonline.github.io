...
1. Додати рівні складності та тематичні підпули задач усередині `task-data`.
2. Ввести `task-evaluators` для складніших сценаріїв, де перевірка перестає бути тривіальною.
3. Додати ще 2-3 нові типи головоломок із сильнішою візуальною складовою.
4. Розширити інтеграційні тести так, щоб вони проходили по кількох типах задач і ловили регресії в i18n/кодуванні на реальному UI.
