...
- [ ] Persistence strategy matches the product mode:
      lessons and long-form tasks save immediately, but **shared-device session games intentionally start fresh on every new page load**
      unless teacher-facing requirements explicitly say otherwise
