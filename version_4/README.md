...
* **Технічні Обмеження та Захист:**
    ...
    * Ліміти на довжину коду (10 000 символів), час виконання (180 секунд, згідно з кодом `constants.js`), глибину вкладених циклів (20 рівнів) та кількість повторень у циклі (100 разів).
