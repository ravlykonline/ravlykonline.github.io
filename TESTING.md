...
**E2E:**
- `editor-layout.spec.js`: відсутність зсуву панелей у режимі «Крок», одна видима кнопка запуску/зупинки, категорії довідки зі стабільним заголовком, нижнє розташування доступності та стан без окремої кнопки читання.
- `step-mode.spec.js` та `stepExecution.test.js`: одна ціла команда на крок, span-підсвічування, пауза/продовження/зупинка, еквівалентність циклів і функцій, бюджети, заборона game stepping і компактне вікно файлів.
