export const lessons = [
  ...
  },
  {
    ...
    intro: {
      icon: '↻',
      title: 'Нова команда: Повторити',
      body: 'Блок «повторити» виконує всі блоки всередині кілька разів. Замість 5 однакових кроків — одна петля!',
  ...
  // Level 7: straight line. Ghost: (0,0)→(0,-100) — heading 0 = up = negative y
  {
    ...
    intro: {
      icon: '🐢',
      title: 'Знайомся: Равлик-Художник!',
      body: 'Тепер Равлик малює лініями. Він стоїть у центрі та дивиться вгору. Команда «вперед» рухає його у поточному напрямку та залишає кольоровий слід.',
      code: 'вперед 100',
    },
    ...
    trailColor: 'var(--color-trail-orange)',
    successMessage: 'Равлик намалював пряму лінію!',
    successTitle: 'Чудово!',
    successButton: 'Наступний рівень →',
  },
  ...
  // Solution: вперед 40, підняти, вперед 25, опустити, вперед 40, підняти, вперед 25, опустити, вперед 40
  {
    ...
    intro: {
      icon: '⬆',
      title: 'Нові команди: Підняти і Опустити',
      body: '«Підняти» піднімає перо — равлик рухається без сліду. «Опустити» опускає перо назад. Так можна малювати пунктири та складні фігури!',
      code: 'вперед 40\nпідняти\nвперед 25\nопустити\nвперед 40',
    },
  ...
  // Solution: вперед 100, праворуч 90, вперед 100
  {
    ...
    intro: {
      icon: '↻',
      title: 'Нова команда: Праворуч',
      body: '«Праворуч 90» повертає равлика на 90° вправо — він не рухається, лише змінює напрямок. Потім «вперед» малює у новому напрямку.',
      code: 'вперед 100\nправоруч 90\nвперед 100',
    },
  ...
  // start (-40, 40): vertices (-40,40),(-40,-40),(40,-40),(40,40)
  {
    ...
    intro: {
      icon: '↻',
      title: 'Повторення + Равлик',
      body: 'Квадрат — 4 однакові сторони. Повтори один блок коду 4 рази замість того, щоб писати одне й те саме чотири рази!',
      code: 'повторити 4 разів {\n  вперед 80\n  праворуч 90\n}',
    },
  ...
  // Level 14: free drawing — no ghost, all tools.
  {
    ...
    instruction: 'Твій равлик, твої правила! Намалюй власний малюнок (щонайменше 8 відрізків).',
    start: { x: 0, y: 0, heading: 0 },
