export const lessons = [
  ...
  // ── Turtle levels ─────────────────────────────────────────────────────────
  {
    ...
    order: 7,
    mode: 'turtle',
    title: 'Рівень 7: Черепаха вперед',
    instruction: 'Намалюй пряму лінію: команда «вперед» з різними значеннями.',
    ...
    trailColor: 'var(--color-trail-orange)',
    successMessage: 'Черепаха намалювала лінію!',
    successTitle: 'Чудово!',
    successButton: 'Наступний рівень →',
  },
  {
    ...
    order: 8,
    mode: 'turtle',
    title: 'Рівень 8: Поворот',
    instruction: 'Намалюй кут: вперед, праворуч 90°, вперед.',
    start: { x: 0, y: 0, heading: 0 },
  ...
  },
  {
    ...
    order: 9,
    mode: 'turtle',
    title: 'Рівень 9: Квадрат',
    instruction: 'Намалюй квадрат: повтори 4 рази «вперед 70, праворуч 90».',
    start: { x: 0, y: 0, heading: 0 },
    ...
    trailColor: 'var(--color-trail-purple)',
    successMessage: 'Квадрат намальовано!',
  ...
  },
  {
    ...
    order: 10,
    mode: 'turtle',
    title: 'Рівень 10: Вільне малювання',
    instruction: 'Малюй що хочеш! Намалюй щонайменше 6 відрізків.',
    start: { x: 0, y: 0, heading: 0 },
