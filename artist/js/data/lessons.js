export const lessons = [
  ...
  // Level 7: straight line. Ghost: (0,0)→(0,-100) — heading 0 = up = negative y
  {
    ...
    intro: {
      icon: '🐢',
      title: 'Знайомся: Черепаха!',
      body: 'Тепер рисує Черепаха. Вона стоїть у центрі та дивиться вгору. Команда «вперед» рухає її у поточному напрямку та залишає слід.',
      code: 'вперед 100',
    },
  ...
  // Solution: вперед 40, підняти, вперед 25, опустити, вперед 40, підняти, вперед 25, опустити, вперед 40
  {
    ...
    intro: {
      ...
      body: '«Підняти» піднімає перо — черепаха рухається без сліду. «Опустити» опускає перо назад. Так можна малювати пунктири та складні фігури!',
      code: 'вперед 40\nпідняти\nвперед 25\nопустити\nвперед 40',
    },
  ...
  // Solution: вперед 100, праворуч 90, вперед 100
  {
    ...
    intro: {
      ...
      body: '«Праворуч 90» повертає черепаху на 90° вправо — вона не рухається, лише змінює напрямок. Потім «вперед» малює у новому напрямку.',
      code: 'вперед 100\nправоруч 90\nвперед 100',
    },
